# -*- coding: utf-8 -*-
# replace _bayes.py in MOBOpt with this (modified filename generation, starting line 476)
import numpy as np
...
class MOBayesianOpt(object):
    ...
    def __PrintOutput(self, front, pop, SaveFile=False):
        ...
        if SaveFile:
            ...
            if slash_pos == -1:
              FrontFilename = FrontFilename + self.Filename
            else:
              FrontFilename = self.Filename[:slash_pos+1] + FrontFilename + self.Filename[slash_pos+1:]
