...
# save data table
labels = ["4K LSB", "4K MSB", "4K CSB", "LSB", "MSB", "CSB", "PROG", "4K READ FW", "READ FW", "WBUF FW 0", "WBUF FW 1", "CH XFER LAT", "ERASE", "CHANNEL BW", "WB SIZE", "UNIX TIME", "EXCEL TIME", "OVERALL PERF"]
