...
#define NAND_4KB_READ_LATENCY_LSB (73000 - 0) //ns
#define NAND_4KB_READ_LATENCY_MSB (73000 + 0) //ns
#define NAND_4KB_READ_LATENCY_CSB (0) //not used
#define NAND_READ_LATENCY_LSB (73000 - 0)
#define NAND_READ_LATENCY_MSB (73000 + 0)
#define NAND_READ_LATENCY_CSB (0) //not used
#define NAND_PROG_LATENCY (695000)
#define NAND_ERASE_LATENCY (0)
