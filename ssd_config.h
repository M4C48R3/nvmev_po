...
#define FLASH_PAGE_SIZE KB(32) // 4 planes per LUN (known) -> but PLNS_PER_LUN should be 1 to not result in a segmentation fault, compensated by this (16KB * 4)
...
#define BLK_SIZE MB(3) // Block Size: 1344 pages, but is that blk-size or line-size? (/16 is for line-size)
static_assert((ONESHOT_PAGE_SIZE % FLASH_PAGE_SIZE) == 0);

#define MAX_CH_XFER_SIZE KB(16) /* to overlap with pcie transfer */
#define WRITE_UNIT_SIZE (512)

#define NAND_CHANNEL_BANDWIDTH (756ull) //MB/s
#define PCIE_BANDWIDTH (3300ull) //MB/s

#define NAND_4KB_READ_LATENCY_LSB (38750) //ns
#define NAND_4KB_READ_LATENCY_MSB (38750)
#define NAND_4KB_READ_LATENCY_CSB (46500)
#define NAND_READ_LATENCY_LSB (43486 - 0)
#define NAND_READ_LATENCY_MSB (43486 + 0)
#define NAND_READ_LATENCY_CSB (52183)
#define NAND_PROG_LATENCY (3300000)
#define NAND_ERASE_LATENCY (3300000)

#define FW_4KB_READ_LATENCY (11428)
#define FW_READ_LATENCY (7272)
#define FW_WBUF_LATENCY0 (2461)
#define FW_WBUF_LATENCY1 (470)
#define FW_CH_XFER_LATENCY (421)
#define OP_AREA_PERCENT (0.2)

#define GLOBAL_WB_SIZE (5033164)
#define WRITE_EARLY_COMPLETION 1
#endif 
///////////////////////////////////////////////////////////////////////////
