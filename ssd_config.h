...
#define NAND_4KB_READ_LATENCY_LSB (85025 - 0) //ns
#define NAND_4KB_READ_LATENCY_MSB (82364 + 0) //ns
#define NAND_4KB_READ_LATENCY_CSB (0) //not used
#define NAND_READ_LATENCY_LSB (13403 - 0)
#define NAND_READ_LATENCY_MSB (116926 + 0)
#define NAND_READ_LATENCY_CSB (0) //not used
#define NAND_PROG_LATENCY (88664)
#define NAND_ERASE_LATENCY (0)

#define FW_4KB_READ_LATENCY (9482)
#define FW_READ_LATENCY (30512)
#define FW_WBUF_LATENCY0 (5554)
#define FW_WBUF_LATENCY1 (76)
#define FW_CH_XFER_LATENCY (0)
