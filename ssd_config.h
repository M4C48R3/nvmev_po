...
#define NAND_4KB_READ_LATENCY_LSB (13646 - 0) //ns
#define NAND_4KB_READ_LATENCY_MSB (11370 + 0) //ns
#define NAND_4KB_READ_LATENCY_CSB (11583) //not used
#define NAND_READ_LATENCY_LSB (2157 - 0)
#define NAND_READ_LATENCY_MSB (11252 + 0)
#define NAND_READ_LATENCY_CSB (3822) //not used
#define NAND_PROG_LATENCY (67077)
#define NAND_ERASE_LATENCY (0)

#define FW_4KB_READ_LATENCY (5228)
#define FW_READ_LATENCY (4213)
#define FW_WBUF_LATENCY0 (7010)
#define FW_WBUF_LATENCY1 (215)
#define FW_CH_XFER_LATENCY (0)
