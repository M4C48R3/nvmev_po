...
#define NAND_4KB_READ_LATENCY_LSB (106714 - 0) //ns
#define NAND_4KB_READ_LATENCY_MSB (160071 + 0) //ns
#define NAND_4KB_READ_LATENCY_CSB (192086) //not used
#define NAND_READ_LATENCY_LSB (229653 - 0)
#define NAND_READ_LATENCY_MSB (344480 + 0)
#define NAND_READ_LATENCY_CSB (413376) //not used
#define NAND_PROG_LATENCY (210052)
#define NAND_ERASE_LATENCY (0)

#define FW_4KB_READ_LATENCY (4992)
#define FW_READ_LATENCY (1677)
#define FW_WBUF_LATENCY0 (5003)
#define FW_WBUF_LATENCY1 (684)
#define FW_CH_XFER_LATENCY (0)
