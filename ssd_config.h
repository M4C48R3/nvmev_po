...
#define NAND_4KB_READ_LATENCY_LSB (30000) //ns
#define NAND_4KB_READ_LATENCY_MSB (30000)
#define NAND_4KB_READ_LATENCY_CSB (36000)
#define NAND_READ_LATENCY_LSB (27000 - 0)
#define NAND_READ_LATENCY_MSB (27000 + 0)
#define NAND_READ_LATENCY_CSB (32400)
#define NAND_PROG_LATENCY (500000)
